    ...
    <div className="navbar ">
      <div className="container">
        <Link to="/" className="flex-1 ">
          <span className="btn btn-ghost normal-case text-xl text-black bg-base-200">
            Home
          </span>
        </Link>
            ...
            {!user?._id && (
              ...
              >
                <li onClick={() => navigate("/sign-in")}>
                  <a className="justify-between text-black">sign in</a>
                </li>
                <li onClick={() => navigate("/sign-up")}>
                  <a className="justify-between text-black">sign up</a>
                </li>
              </ul>
            )}
          </div>
